...
const Time_Value Time_Value::max(LONG_MAX, LONG_MAX);
...
long Time_Value::get_msec_gap(const Time_Value &tv1, const Time_Value &tv2) {
	long sec_gap = tv1.sec() - tv2.sec();
	long usec_gap = tv1.usec() - tv2.usec();
	return sec_gap * 1000 + usec_gap / 1000;
}
